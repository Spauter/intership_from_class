...
public class SimpleClassScan {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        Set<Class<?>>classes=scan.scan("com.bloducspauter");
        for (Class<?>clas:classes){
//            System.out.println(clas);
            String[] strings=clas.toString().split(" ");
            String className= Arrays.stream(strings).reduce((first, second) -> second).orElse(0+"");
