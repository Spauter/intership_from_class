...
//地址栏输入: http://127.0.0.1:80/mylike.s?like=篮球&like=电影&like=手游 浏览器显示爱好列表, 将输入的爱好全部显示在 ol 列表中 提示: 实现 请求对象的 public String[] getParameterValues(String name) 方法
@WebServlet("/mylike.s")
