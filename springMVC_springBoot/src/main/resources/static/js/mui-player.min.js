...
!function (e, t) {
    ...
    var MuiPlayer = function MuiPlayer(config) {
        var _this = this;
        _this._global_ = {};
        var webpagePlugin = "", mobilePlugin = "", hls = null, flv = null, option = config || {},
        ...
        con && ($CONSTANT = {
            ...
            getLanguageText: function () {
                ...
                for (var t = $node.video + $node.mplayerPoster + $node.mplayerCover + $node.mplayerLoading + $node.mplayerError + $node.mplayerHeader + $node.mplayerFooter + $node.miniProgress, t = $node.logWrite ? t + $node.logWrite : t, o = 0; o < plugins.length; o++) if (plugins[o] instanceof Object) {
                ...
                e && $method.removeNode(con, "#mplayer-media-wrapper"), (e = document.createElement("div")).setAttribute("id", "mplayer-media-wrapper"), e.setAttribute("class", "player-wrapper"), e.appendChild(t), $el.mPlayer.appendChild(e), option.src ? ($method.playerReady(), setTimeout(function () {
                    _this._global_.isReady = !0, _this.emit("ready"), setTimeout(function () {
                ...
                $method.resetVariable(), !0 === option.autoplay && ($data.mediaPlayDirectives = 1, $method.onPlay()), $method.toggleEventListenerGlobal("add", "playerReady"), $method.toggleEventListenerCustom("add"), $method.nodesObserver()
                ...
                for (var e = 0, t = Object.keys($el); e < t.length; e++) {
                    ...
                    "mPlayer" != o && ($el[o] || ($el[o] = {
                        ...
                        return e[0] || {exist: !1, style: {}, height: "", width: ""}
                    })
                }
                ...
                for (var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 5, t = "", o = 0; o < e; o++) t += String.fromCharCode(Math.floor(26 * Math.random()) + "a".charCodeAt(0));
                return t
                ...
                if (0 < o.length) {
                    ...
                    try {
                        for (n.s(); !(r = n.n()).done;) {
                            var i = r.value;
                            e.style[$method.parseCamel(i)] = t[i]
                        }
                    } catch (e) {
                        n.e(e)
                    } finally {
                ...
                for (var t = option.custom || {}, o = t.headControls || [], r = 0; r < o.length && !(5 <= r); r++) o[r] instanceof Object && o[r].slot && (i = o[r].slot, (l = $el.mPlayer.querySelector("[slot=" + i + "]")) && (a = "TEMPLATE" == l.tagName ? l.content.cloneNode(!0) : $method.createRangeIsDocFragment(l.innerHTML), (s = document.createElement("button")).setAttribute("class", "player-btn header-control"), s.setAttribute("slot", i), s.setAttribute("control", ""), o[r].click instanceof Function && s.classList.add("keyboard-input"), o[r].style && o[r].style instanceof Object && $method.setElementStyle(s, o[r].style), s.appendChild(a), e.querySelector("#buttom-group").insertBefore(s, e.querySelector("#buttom-group .header-control")), l.style.display = "none"));
                for (var n = t.footerControls || [], r = 0; r < n.length && !(5 <= r); r++) n[r] instanceof Object && n[r].slot && (i = n[r].slot, (l = $el.mPlayer.querySelector("[slot=" + i + "]")) && (a = "TEMPLATE" == l.tagName ? l.content.cloneNode(!0) : $method.createRangeIsDocFragment(l.innerHTML), (s = document.createElement("button")).setAttribute("class", "player-btn footer-control"), s.setAttribute("slot", i), s.setAttribute("control", ""), n[r].tooltip && s.setAttribute("tooltip", n[r].tooltip), n[r].click instanceof Function && s.classList.add("keyboard-input"), n[r].style && n[r].style instanceof Object && $method.setElementStyle(s, n[r].style), s.appendChild(a), "left" == n[r].position ? e.querySelector("#mplayer-footer #left-part").appendChild(s) : e.querySelector("#mplayer-footer #right-part").insertBefore(s, e.querySelector("#mplayer-footer #right-part").childNodes[0]), l.style.display = "none"));
                for (var i, l, a, s, c, d = t.rightSidebar || [], r = 0; r < d.length && !(5 <= r); r++) d[r] instanceof Object && d[r].slot && (i = d[r].slot, (l = $el.mPlayer.querySelector("[slot=" + i + "]")) && (a = "TEMPLATE" == l.tagName ? l.content.cloneNode(!0) : $method.createRangeIsDocFragment(l.innerHTML), (s = document.createElement("div")).appendChild(a), s.setAttribute("slot", i), s.setAttribute("class", "mplayer-sidebar"), c = d[r].width || "", $CONSTANT.unitLengthReg.test(c) && (s.style.width = isNaN(Number(c)) ? c : c + "px"), e.appendChild(s), l.style.display = "none"));
                return e
            }, initConfigControl: function (e) {
                !1 !== option.showMiniProgress && !0 !== option.live || $method.removeNode(e, "#mini-progress"), !0 === option.live ? (e.querySelector("#live-mode .mode-text").innerText = $method.getLangObject().live, $method.removeNode(e, "#progress-container")) : $method.removeNode(e, "#live-mode"), !1 === option.pageHead && (e.querySelector("#mplayer-header").style.opacity = 0);
                ...
                if ("[object Array]" === Object.prototype.toString.call(o) && 0 < o.length) {
                    for (var n = document.createDocumentFragment(), i = 0; i < o.length; i++) {
                        var l, a = o[i];
                        "object" == _typeof(a) && /.\.vtt$/.test(a.src) && ((l = document.createElement("track")).setAttribute("src", a.src), l.setAttribute("kind", a.kind || "subtitles"), l.setAttribute("label", a.label || "字幕" + (i + 1)), a.srclang && l.setAttribute("srclang", a.srclang), !0 === a.default && l.setAttribute("default", !0), n.appendChild(l))
                    }
                ...
                var i, o = option.height || "225px";
                !$CONSTANT.unitLengthReg.test(o) && !0 !== e || $data.isFullScreen || (i = isNaN(Number(o)) ? o : o + "px", $el.mPlayer.style.height = !0 === e ? r + "px" : i, !0 === e && !1 === option.autoFit && setTimeout(function () {
                    $el.mPlayer.style.height = i
                }, 800)), 0 <= option.volume && option.volume <= 1 && (a.querySelector("video").volume = option.volume), !0 === option.muted && (a.querySelector("video").muted = !0);

                function l(e, t) {
                    var o = a.querySelector("video");
                    if ("src" == e) {
                        var r = option.parse || {}, n = r.type, i = r.loader, l = r.config || {};
                        if (r.customKernel && r.customKernel instanceof Function) return console.info("custom kernel..."), r.customKernel(o, t), 0;
                        if (o.setAttribute(e, t), "hls" == n) {
                            if ("function" != typeof i) return;
                            1 == i.isSupported() ? $method.hlsDecodeAction(o, t, {
                                loader: i,
                                config: l
                            }) : console.error("browser does not support hls js. to check whether your browser is supporting MediaSource Extensions.")
                        }
                        "flv" == n && "object" == _typeof(i) && (1 == i.isSupported() ? $method.flvDecodeAction(o, t, {
                            loader: i,
                            config: l
                ...
                option.src && l("src", option.src), !0 === option.autoplay && l("autoplay", "autoplay"), 1 == option.autoplay || option.preload && l("preload", option.preload), option.loop && l("loop", "loop");
                var s = option.videoAttribute || [];
                if (0 < s.length) for (var c = 0; c < s.length; c++) l(s[c].attrKey, s[c].attrValue);
                ...
                var r = Object.assign({autoStartLoad: !0 === option.autoplay || "none" != option.preload}, o.config);
                ...
                (flv = o.loader.createPlayer(t)).attachMediaElement(e), !0 !== option.autoplay && "none" == option.preload || flv.load(), flv.on(o.loader.Events.ERROR, $method.onError)
                ...
                window.plus && (this._landscape_lock = function () {
                    plus.navigator.setFullscreen(!0), plus.screen.lockOrientation("landscape"), setTimeout(function () {
                        plus.navigator.hideSystemNavigation()
                    }, 200), setTimeout(function () {
                        var e = plus.navigator.getStatusbarHeight(), e = $method.hasNotchInScreen() ? e + 10 : 10;
                        $el.mplayerHeader.style.paddingLeft = e + "px", $el.mplayerHeader.style.paddingRight = e + "px", $el.mplayerFooter.style.paddingLeft = e + "px", $el.mplayerFooter.style.paddingRight = e + "px", $el.progressContainer.style.left = e + "px", $el.progressContainer.style.right = e + "px"
                    }, 100)
                }, this._portrait_lock = function () {
                    plus.navigator.setFullscreen(!1), plus.screen.lockOrientation("portrait"), setTimeout(function () {
                ...
                "ios" != $method.returnSys() ? (e = function () {
                    ...
                    e(), !1 === option.pageHead && ($el.mplayerHeader.style.opacity = 1)
                ...
                if ($data.isPlay || "none" == t) $el.videoObject.pause(); else if (!$data.isPlay) {
                ...
                var e;
                (t = t || {}).stopPropagation && t.stopPropagation(), $data.isTouchMove || (e = function (e) {
                    _this._global_.triggerDblclickEvent || (mobilePlugin ? new mobilePlugin.interface(t)._onAgentMpTap("dbclick") : webpagePlugin ? new webpagePlugin.interface(t)._onAgentMpTap("dbclick") : $method.onPlayTap({type: "dblscreen"}), _this._global_.triggerDblclickEvent = !0, setTimeout(function () {
                ...
                var e = $el.videoObject, t = $el.mPlayer.getBoundingClientRect(), o = t.width, r = t.height,
                    n = e.videoHeight / e.videoWidth, i = r / o, l = {videoWidth: 0, videoHeight: 0},
                    e = $el.mPlayer.classList;
                return !e.contains("browser-fullscreen") && !e.contains("page-fullscreen") && 0 != option.autoFit || i.toFixed(2) > n.toFixed(2) ? (l.videoWidth = o.toFixed(), l.videoHeight = (o * n).toFixed()) : (i.toFixed(2) < n.toFixed(2) ? l.videoWidth = (r / n).toFixed() : l.videoWidth = o.toFixed(), l.videoHeight = r.toFixed()), l
                ...
                $data.isPlay = !1, setTimeout(function () {
                    $method.hideLoading()
                }, 500), $el.playSwitch.querySelector("._play").style.display = "block", $el.playSwitch.querySelector("._pause").style.display = "none", window.plus && plus.device.setWakelock(!1)
            }, onPlay: function (e) {
                setTimeout(function () {
                ...
                }), $method.removeOriginControls(), window.plus && plus.device.setWakelock(!0), $data.isPlay = !0, 1 < $data.duration && 1 != $el.videoObject.style.opacity && setTimeout(function () {
                ...
                for (var b, b1, b2, b3, d = 0, s, s = new Array(Math.floor(str.length / 3)), b = s.length, i = 0; i < b; i++) b1 = $CONSTANT.encodeKey.indexOf(str.charAt(d)), d++, b2 = $CONSTANT.encodeKey.indexOf(str.charAt(d)), d++, b3 = $CONSTANT.encodeKey.indexOf(str.charAt(d)), d++, s[i] = 36 * b1 * 36 + 36 * b2 + b3;
                return b = eval("String.fromCharCode(" + s.join(",") + ")"), b
            }, formatCurrentTime: function (e) {
                var t = parseInt(e / 3600), t = 3600 <= $data.duration || 0 < t ? "0" + t.toString() + ":" : "",
                    o = 0 <= (o = parseInt(e % 3600 / 60)) && 1 == o.toString().length ? "0" + o.toString() + ":" : o + ":",
                    e = 0 <= (e = parseInt(e % 60)) && 1 == e.toString().length ? "0" + e.toString() : e;
                return t.toString() + o.toString() + e.toString()
            }, updateProgressBar: function (e) {
                $data.percentage = e, $el.progressBall.style.left = $data.percentage + "%", $el.progressPlay.style.width = $data.percentage + "%", $method.computePlayTime($data.percentage, $data.duration, function (e) {
                ...
                $method.computeProgress(e, t, function (e) {
                    ...
                    100 <= e ? e = 100 : e <= 0 && (e = 0), $method.updateProgressBar(e), r && r()
                })
                ...
                if ((t = t || {}).stopPropagation && t.stopPropagation(), t.preventDefault && t.preventDefault(), $data.mediaStatus && $data.duration != 1 / 0 && "NaN" != $data.duration) {
                    var e = function () {
                        $data.ball_move_status = !0, $method.createTimerCloseControl({type: "cancel"}), $data.startX = ("touchstart" == t.type ? t.touches[0] : t).clientX, $data._defaultPlayProgressPro = 0;
                        var e = $el.touchEffective.getClientRects()[0], e = $data.startX - e.left;
                        $method.progressControlHandle(e, $el.touchEffective), $data._defaultPlayProgressPro = $el.progressPlay.style.width.substr(0, $el.progressPlay.style.width.length - 1) || 0, "touchstart" == t.type ? ($el.touchEffective.addEventListener("touchmove", $method.progressBarSeeking), $el.touchEffective.addEventListener("touchend", $method.progressBarSeeking), $el.touchEffective.addEventListener("touchcancel", $method.progressBarSeeking)) : (document.addEventListener("mousemove", $method.progressBarSeeking), document.addEventListener("mouseup", $method.progressBarSeeking))
                    }, o = function () {
                        $data.moveX = ("touchmove" == t.type ? t.touches[0] : t).clientX, $data.isTouchMove || ($data.isTouchMove = !0, $el.progressBall.querySelector(".progress-ball").style.boxShadow = "0 0 20px 3px " + $habit.themeColor, mobilePlugin && (new mobilePlugin.interface)._onAgentEventAction("touchmove-footerbar")), $data.startX || ($data.startX = $data.moveX);
                ...
                for (var e = !1, t = $el.mPlayer.querySelectorAll(".mplayer-sidebar"), o = 0; o < t.length; o++) t[o].classList.contains("open") && (t[o].classList.remove("open"), e = !($data.isShowRightSidebar = !1), "object" == _typeof(_this._global_.webpagePlugin) && "removeEventListener" == _this._global_.webpagePlugin.eventStatus && (new webpagePlugin.interface)._addEvent());
                return e
                ...
                if (!t && "DOMContentLoaded" != e.type && "resize" != e.type && "orientationchange" != e.type) {
                    var r = ["webkitTransform", "transform", "msTransform"], o = function () {
                        ...
                        for (var e = $el.mplayerHeader.getBoundingClientRect().height, t = 0; t < r.length; t++) $el.mplayerHeader.style[r[t]] = "translateY(" + -e + "px)"
                    }, i = function () {
                        $el.mplayerFooter.classList.toggle("show", !0), $el.miniProgress.style.opacity = 0
                    }, t = function () {
                        $el.mplayerFooter.classList.toggle("show", !1);
                        for (var e = $el.mplayerFooter.getBoundingClientRect().height, t = $el.progressContainer.classList.contains("upper-position") ? Number.parseInt($el.progressContainer.getBoundingClientRect().height / 2) + 1 : 0, o = 0; o < r.length; o++) $el.mplayerFooter.style[r[o]] = "translateY(" + (e + t) + "px)";
                ...
                $data.isPlay = !1, _this._global_.mp_timeout_1 || (_this._global_.mp_timeout_1 = setTimeout(function () {
                ...
                $data.isDestroy && 1 <= $data.playError || setTimeout(function () {
                    ...
                    }, {once: !0}), _this.emit("error", _toConsumableArray(t)))
                }, 3e3)
                ...
                var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
                    o = {message: "", duration: 1500, style: {}};
                "string" == typeof t && (o.message = t), "object" == _typeof(t) && Object.keys(o).forEach(function (e) {
                    t[e] && (o[e] = t[e])
                });
                var r, e = 0 < ("number" == typeof o.duration && o.duration) ? o.duration : 1500,
                    n = $el.mPlayer.querySelector("#mplayer-media-wrapper");
                n.querySelector("#mplayer-toast") && $method.removeNode(n, "#mplayer-toast"), (r = document.createElement("div")).setAttribute("class", "mplayer-toast toast-scaling"), r.setAttribute("id", "mplayer-toast"), r.innerHTML = o.message, "[object Object]" == Object.prototype.toString.call(o.style) && Object.keys(o.style).forEach(function (e) {
                    r.style[e] = o.style[e]
                }), n.appendChild(r), r.addEventListener("click", function (e) {
                    e.stopPropagation()
                ...
                for (var t, o = (option.custom || {}).footerControls || [], r = 0; r < o.length; r++) !0 !== o[r].oftenShow && (t = o[r].slot, (t = $el.mplayerFooter.querySelector("[slot=" + t + "]")) && ("portrait" == e && (t.style.display = "none"), "landscape" == e && (t.style.display = "block")))
            }, onDocVisibilitychange: function (e) {
                !1 !== $data.showScreenControls && $method.createTimerCloseControl({type: "visible" == document.visibilityState ? "" : "cancel"})
                ...
                function t() {
                    $method.toggleControlsDisplay(e), $el.progressContainer.classList.remove("upper-position"), $method.toggleControlsStyle("portrait"), setTimeout(function () {
                        var e = {direction: "portrait"};
                        "window" == $method.returnSys() && (e.fullscreen = $data.isFullScreen), _this.emit("fullscreen-change", e)
                ...
                var e = new MutationObserver(function (e, t) {
                    var o, r = _createForOfIteratorHelper(e);
                    try {
                        for (r.s(); !(o = r.n()).done;) {
                            var n = o.value;
                            if ("childList" === n.type) {
                                var i, l = _createForOfIteratorHelper(n.removedNodes);
                                try {
                                    for (l.s(); !(i = l.n()).done;) {
                                        var a = i.value;
                                        if (a instanceof HTMLVideoElement) {
                                            hls && hls.media && (hls.destroy(), hls = ""), flv && (flv.destroy(), flv = ""), document.pictureInPictureElement == a && document.exitPictureInPicture(), a.pause(), a.removeAttribute("src"), t.disconnect();
                                            break
                                        }
                                    }
                                } catch (e) {
                ...
                var t = option.custom || {}, o = "add" == e ? "addEventListener" : "removeEventListener",
                    r = t.headControls || [];
                if (0 < r.length) for (var n = 0; n < r.length; n++) !r[n].click instanceof Function || (l = r[n].slot, (a = $el.headerMenu.querySelector("[slot=" + l + "]")) instanceof Element && a[o]("click", r[n].click));
                var i = t.footerControls || [];
                if (0 < i.length) for (var l, a, n = 0; n < i.length; n++) !i[n].click instanceof Function || (l = i[n].slot, (a = $el.mplayerFooter.querySelector("[slot=" + l + "]")) instanceof Element && a[o]("click", i[n].click))
                ...
                o = "onorientationchange" in window ? "orientationchange" : "resize", window[r](o, $method.onScreenResize), $el.backButton[r]("click", $method.onBack), $el.fullSwitch[r]("click", $method.fullToggle), $el.playSwitch[r]("click", $method.onPlayTap), $el.mPlayer[r]("click", $method.onContrainerTap), $el.mPlayer[r]("dblclick", $method.onContrainerTap), $el.touchEffective instanceof Element && $el.touchEffective[r]("touchstart", $method.progressBarSeeking), $el.touchEffective instanceof Element && $el.touchEffective[r]("mousedown", $method.progressBarSeeking), $el.videoObject[r]("webkitbeginfullscreen", $method.runtimeCompatibleHandle), $el.videoObject[r]("webkitendfullscreen", $method.runtimeCompatibleHandle), document[r]("resume", $method.plusRuntimeHandle), document[r]("pause", $method.plusRuntimeHandle), document[r]("visibilitychange", $method.onDocVisibilitychange), "playerReady" == t && function () {
                    ...
                    for (var e = $el.mPlayer.querySelectorAll(".mplayer-sidebar"), t = 0; t < e.length; t++) e[t].addEventListener("touchstart", function (e) {
                        e.stopPropagation()
            ...
            e && e.classList.contains("mplayer-sidebar") && ($method.createTimerCloseControl({type: "cancel"}), $method.toggleControlsDisplay({type: "sidebarRight"}), e.classList.add("open"), $data.isShowRightSidebar = !0, webpagePlugin && (new webpagePlugin.interface)._removeEvent())
        }, this.toggleControls = function (e) {
            !0 === e ? 0 == $data.showScreenControls ? $method.toggleControlsDisplay({type: "showControls"}) : $method.createTimerCloseControl() : !1 === e ? 1 == $data.showScreenControls && $method.toggleControlsDisplay({type: "hideControls"}) : $method.toggleControlsDisplay();
            e = new Object;
            return e.closeTimer = function () {
                _this._global_.mp_timeout_3 && clearTimeout(_this._global_.mp_timeout_3), $data.isControlsTimer = !1
            }, e.openTimer = function () {
                $data.isControlsTimer = !0
            }, e
    ...
    return MuiPlayer.prototype.on = function (e, t, o) {
        ...
        if (this._event_[e]) for (var o = 0; o < this._event_[e].length; o++) {
